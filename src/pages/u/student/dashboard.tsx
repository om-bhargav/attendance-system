    ...
    <>
      ...
      <div className="flex flex-col p-5 my-5 justify-center items-start container lg:flex-row max-w-[1200px] gap-5 mx-auto">
        <div className="max-w-[800px] w-full flex flex-col gap-5">
          <div className="border border-gray-200 rounded p-3 shadow-lg text-2xl text-center flex flex-col lg:flex-row gap-5 items-center">
            <img src="/default.png" className="h-20 rounded" />
            Welcome, {user.name}
          </div>
          <div className="border border-gray-200 grid text-center gap-5 rounded py-5 p-3 shadow-lg">
            ...
            <div className="gap-5 grid md:grid-cols-2 min-h-[150px] text-2xl">
              <Link className="grid" to={`/view-attendance/${user.id}`}>
